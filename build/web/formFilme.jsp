...
<%-- Adicionando a biblioteca de tags JSTL, essencial para a correção --%>
    ...
    <body class="bg-dark text-white index-body">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark"><div class="container-fluid">
                ...
                <div class="d-flex gap-2">
                    <a href="FilmeServlet?action=listar" class="btn btn-outline-info ms-2"><i class="bi bi-star-half"></i> Ver Lista Completa</a>
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4">
                    <div class="card filme-card-dreamcore text-white shadow-lg h-100">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <p class="card-text mb-1"><small><strong>Descrição:</strong> <%= f.getDescricao() %></small></p>
        ...
        <script>
                                        document.addEventListener('DOMContentLoaded', function () {
                                            ...
                                            setupCounter('sugerirDescricao', 'sugerirCharCount', 500);
                                            setupCounter('editFormDescricao', 'editCharCount', 500);
